      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <h2 className={`text-4xl md:text-5xl font-bold mb-4 ${
            theme === 'light' ? 'text-gray-900' : 'text-dark'
          }`}>
            About Me
          </h2>
              ...
              <div className="flex items-start gap-4 mb-4">
                <div className={`p-3 rounded-xl ${
                  ...
                  <Code className={`w-6 h-6 ${
                    theme === 'light' ? 'text-blue-600' : 'text-dark'
                  }`} />
                </div>
                <div>
              ...
              <div className="flex items-start gap-4 mb-4">
                <div className={`p-3 rounded-xl ${
                  ...
                  <Palette className={`w-6 h-6 ${
                    theme === 'light' ? 'text-purple-600' : 'text-dark'
                  }`} />
                </div>
          ...
          <div className="space-y-4 animate-fade-in-right">
            <div className={`p-6 rounded-2xl border backdrop-blur-sm ${
              ...
              <div className="flex items-center gap-3 mb-6">
                <Heart className={`w-6 h-6 ${
                  theme === 'light' ? 'text-red-500' : 'text-dark'
                }`} />
              ...
              <div className="space-y-4">
                {interests.map((interest, index) => (
                  <div
                    key={index}
                    className={`p-4 rounded-xl transition-all duration-300 hover:scale-[1.02] cursor-default group ${
                      theme === 'light'
            ...
            <div className={`p-6 rounded-2xl border backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] ${
              ...
              <p className={`text-center font-medium ${
                theme === 'light' ? 'text-gray-900' : 'text-gray-450'
              }`}>
